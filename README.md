...
|----------------------|-----------------------------------------------------|
| 2026-03-06 10:42:07  | Added native iOS companion app (SwiftUI, iOS 17+) under ios/CentreTracker/: reads pool schedule JSON from GitHub raw content URLs; includes Venue model, PoolTimes Codable structs, ScheduleService network layer, and VenueListView/VenueScheduleView/SessionRowView SwiftUI views |
...
| 2026-03-05 21:25:42  | index.html: when open show pool closing time (last session end); when closed show full pool hours (first–last session) for next open day |
