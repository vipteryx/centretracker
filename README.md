...
A Node.js web scraper that monitors Vancouver Community Centre swimming pool schedules and stores the data as JSON. Currently tracks **Hillcrest**, **Britannia**, **Vancouver Aquatic Centre**, **Templeton**, and **Renfrew** community centres.
